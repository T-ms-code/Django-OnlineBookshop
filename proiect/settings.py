...
EMAIL_PORT = 587 
EMAIL_USE_TLS = True 
EMAIL_HOST_USER = 'djangoproiect@gmail.com'
EMAIL_HOST_PASSWORD = 'parola_falsa'
DEFAULT_FROM_EMAIL = 'Da-Boss <djangoproiect@gmail.com>'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
                'options': '-c search_path=proiect'
        },
        'NAME': 'mihaibase1',   # numele bazei de date
        'USER': 'mihai',      # username pt conexiunea la baza de date
        'PASSWORD': 'parola_falsa',
...
MESSAGE_LEVEL = message_constants.DEBUG##ALTFEL AFISA DOAR DE LA NIVELUL INFO IN SUS!